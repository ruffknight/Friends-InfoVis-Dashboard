...
!(function (t, n) {
    ...
    if ((e && 1 === e.length) || n.length > 1) {
      ...
      return (
        n.length > 1
          ...
          : ((e = t.map(e)), r.sort((t, n) => q(e[t], e[n]))),
        P(t, r)
      );
    }
  ...
  function Y(t, n, e) {
    var r = (n - t) / Math.max(0, e),
      ...
      o = r / Math.pow(10, i);
    return i >= 0
      ? (o >= O ? 10 : o >= I ? 5 : o >= U ? 2 : 1) * Math.pow(10, i)
      : -Math.pow(10, -i) / (o >= O ? 10 : o >= I ? 5 : o >= U ? 2 : 1);
  }
  function L(t, n, e) {
  ...
  function X() {
    ...
    return (
      ...
      (r.domain = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : F([t[0], t[1]])), r)
          : n;
      }),
  ...
  function $(t, n, e = 0, r = t.length - 1, i) {
  ...
  function St(t) {
    ...
    return (
      ...
      Tt.hasOwnProperty(n) ? { space: Tt[n], local: t } : t
    );
  }
  function Et(t) {
    return function () {
  ...
  function dn(t, n) {
    for (var e = ln(t), r = -1, i = n.length; ++r < i; ) e.add(n[r]);
  }
  function pn(t, n) {
    for (var e = ln(t), r = -1, i = n.length; ++r < i; ) e.remove(n[r]);
  }
  function gn(t) {
    return function () {
      dn(this, t);
  ...
  function Un(t) {
    return "string" == typeof t
      ? new On([[document.querySelector(t)]], [document.documentElement])
      : new On([[t]], Fn);
  }
  On.prototype = In.prototype = {
    ...
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each(
            (null == n ? en : "function" == typeof n ? on : rn)(
              t,
              n,
              null == e ? "" : e
            )
    ...
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? un : "function" == typeof n ? fn : cn)(t, n))
        : this.node()[t];
    },
    ...
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? xn : ("function" == typeof t ? Mn : wn)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each(An);
    ...
    on: function (t, n, e) {
      var r,
        ...
        a = o.length;
      if (!(arguments.length < 2)) {
        for (u = n ? zn : Pn, r = 0; r < a; ++r) this.each(u(o[r], n, e));
        return this;
      }
  ...
  function xe(t) {
    ...
    return (
      ...
      (n = le.exec(t))
        ...
        : (n = ye.exec(t))
        ? Ce(n[1], n[2] / 100, n[3] / 100, 1)
        : (n = ve.exec(t))
        ? Ce(n[1], n[2] / 100, n[3] / 100, n[4])
        : _e.hasOwnProperty(t)
        ? we(_e[t])
        : "transparent" === t
  ...
  function Ae(t) {
    return (
      t instanceof oe || (t = xe(t)),
      t ? new Se((t = t.rgb()).r, t.g, t.b, t.opacity) : new Se()
    );
  }
  function Te(t, n, e, r) {
      ...
      ie(oe, {
        ...
        rgb: function () {
          var t = (this.h % 360) + 360 * (this.h < 0),
            ...
            i = 2 * e - r;
          return new Se(
            qe(t >= 240 ? t - 240 : t + 120, i, r),
            qe(t, i, r),
            qe(t < 120 ? t + 240 : t - 120, i, r),
            this.opacity
          );
        },
        displayable: function () {
  ...
  function Le(t) {
    ...
    var n,
      ...
      i = $e(t.g),
      o = $e(t.b),
      a = Xe((0.2225045 * r + 0.7168786 * i + 0.0606169 * o) / 1);
    return (
      r === i && i === o
        ? (n = e = a)
        : ((n = Xe((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Oe)),
          (e = Xe((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / Ie))),
      new He(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity)
    );
  }
  function je(t, n, e, r) {
  ...
  function Xe(t) {
    return t > 0.008856451679035631 ? Math.pow(t, 1 / 3) : t / Ye + Ue;
  }
  function Ge(t) {
  ...
  function We(t) {
    ...
    if ((t instanceof He || (t = Le(t)), 0 === t.a && 0 === t.b))
      return new Ke(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
    ...
    ie(oe, {
      ...
      rgb: function () {
        ...
        return new Se(
          ...
          Ve(-0.9787684 * n + 1.9161415 * t + 0.033454 * e),
          Ve(0.0719453 * n - 0.2289914 * t + 1.4052427 * e),
          this.opacity
        );
      },
    })
  ...
  re(
    ...
    ie(oe, {
      brighter: function (t) {
        return (
          (t = null == t ? ue : Math.pow(ue, t)),
          new fr(this.h, this.s, this.l * t, this.opacity)
        );
      },
      darker: function (t) {
        return (
  ...
  function gr(t, n) {
    var e = n - t;
    return e
      ? pr(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
      : dr(isNaN(t) ? n : t);
  }
  function yr(t) {
    return 1 == (t = +t)
    ...
    Ur = Or(
      function (t) {
        return null == t
          ? Rr
          : (Dr ||
              (Dr = document.createElementNS(
                "http://www.w3.org/2000/svg",
                "g"
              )),
            Dr.setAttribute("transform", t),
            (t = Dr.transform.baseVal.consolidate())
              ? Fr((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f)
              : Rr);
      },
      ", ",
      ")",
  ...
  function gi(t) {
    ti ||
      ...
      t - ii > 24
        ? (t < 1 / 0 && (ni = setTimeout(di, t - ai.now() - oi)),
          ei && (ei = clearInterval(ei)))
        : (ei || ((ri = ai.now()), (ei = setInterval(pi, 1e3))),
          (ti = 1),
          ui(di)));
  }
  function yi(t, n, e) {
  ...
  si.prototype = li.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? ci() : +e) + (null == n ? 0 : +n)),
        this._next ||
          Jr === this ||
          (Jr ? (Jr._next = this) : (Qr = this), (Jr = this)),
        (this._call = t),
        (this._time = e),
        gi();
    },
  ...
  Ki.prototype = Qi.prototype = {
    ...
    attr: function (t, n) {
      ...
      return this.attrTween(
        t,
        "function" == typeof n
          ? (e.local ? Di : zi)(e, r, Si(this, "attr." + t, n))
          : null == n
          ? (e.local ? Ni : ki)(e)
          : (e.local ? Pi : Ci)(e, r, n)
      );
        ...
        ? this.styleTween(
            ...
            (function (t, n, e) {
              ...
              return function () {
                ...
                return (
                  null == u &&
                    (this.style.removeProperty(t), (c = u = an(this, t))),
                  a === c
                    ? null
                    : a === r && c === i
                    ? o
    ...
    tween: function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = wi(this.node(), e).tween, o = 0, a = i.length;
          o < a;
          ++o
        )
    ...
    delay: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? Ii : Ui)(n, t))
        : wi(this.node(), n).delay;
    },
    duration: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? Bi : Yi)(n, t))
        : wi(this.node(), n).duration;
    },
    ease: function (t) {
      var n = this._id;
  ...
  function go(t) {
    return (t = +t) < ho
      ...
      ? po * (t -= 0.5454545454545454) * t + 0.75
      : t < 0.9090909090909091
      ? po * (t -= 0.8181818181818182) * t + 0.9375
      : po * (t -= 0.9545454545454546) * t + 0.984375;
  }
  var yo = 1.70158,
    vo = (function t(n) {
      function e(t) {
    ...
    Mo = (function t(n, e) {
      ...
      function i(t) {
        return (
          ((t = 2 * t - 1) < 0
            ? n * fo(-t) * Math.sin((r - t) / e)
            : 2 - n * fo(t) * Math.sin((r + t) / e)) / 2
        );
      }
      return (
        (i.amplitude = function (n) {
  ...
  (In.prototype.interrupt = function (t) {
    ...
    (In.prototype.transition = function (t) {
      ...
      t instanceof Ki
        ? ((n = t._id), (t = t._name))
        : ((n = Ji()), ((e = Ao).time = ci()), (t = null == t ? null : t + ""));
  ...
  var Po = { name: "drag" },
    ...
    Do = { name: "handle" },
    qo = { name: "center" };
  const { abs: Ro, max: Fo, min: Oo } = Math;
  function Io(t) {
    return [+t[0], +t[1]];
  }
  function Uo(t) {
  ...
  function ta(t) {
    ...
    function h(e) {
      if ((!n || e.touches) && r.apply(this, arguments)) {
        ...
        if ("overlay" === b) {
          ...
          (M.selection = T =
            [
              [
                (i = t === Yo ? S : Oo(n[0][0], n[1][0])),
                (u = t === Bo ? E : Oo(n[0][1], n[1][1])),
              ],
              [
                (l = t === Yo ? k : Fo(n[0][0], n[1][0])),
                (d = t === Bo ? N : Fo(n[0][1], n[1][1])),
              ],
            ]),
            D.length > 1 && U(e);
      ...
      function I(t) {
        for (const n of t.changedTouches || [t])
          for (const t of D)
            t.identifier === n.identifier && (t.cur = Hn(n, _));
        if (z && !y && !v && 1 === D.length) {
          const t = D[0];
      ...
      function U(t) {
        ...
        switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
          case zo:
          case Po:
            x && ((C = Fo(S - i, Oo(k - l, C))), (a = i + C), (h = l + C)),
              w && ((P = Fo(E - u, Oo(N - d, P))), (c = u + P), (p = d + P));
            break;
          case Do:
            D[1]
              ? (x &&
                ...
                w &&
                  ...
                  (w = 1)))
              : (x < 0
                  ? ((C = Fo(S - i, Oo(k - i, C))), (a = i + C), (h = l))
                  : x > 0 &&
                    ((C = Fo(S - l, Oo(k - l, C))), (a = i), (h = l + C)),
                w < 0
                  ? ((P = Fo(E - u, Oo(N - u, P))), (c = u + P), (p = d))
                  : w > 0 &&
                    ((P = Fo(E - d, Oo(N - d, P))), (c = u), (p = d + P)));
            break;
          case qo:
            x && ((a = Fo(S, Oo(k, i - C * x))), (h = Fo(S, Oo(k, l + C * x)))),
              w &&
                ((c = Fo(E, Oo(N, u - P * w))), (p = Fo(E, Oo(N, d + P * w))));
        }
        h < a &&
          ((x *= -1),
          (r = i),
          ...
          (a = h),
          (h = r),
          b in Ho && F.attr("cursor", jo[(b = Ho[b])])),
          p < c &&
            ((w *= -1),
            (r = u),
            (u = d),
            ...
            (c = p),
            (p = r),
            b in Xo && F.attr("cursor", jo[(b = Xo[b])])),
      ...
      function B(t) {
        ...
        R.attr("pointer-events", "all"),
          F.attr("cursor", jo.overlay),
          M.selection && (T = M.selection),
          Jo(T) && ((M.selection = null), f.call(_)),
          q.end(t, m.name);
      }
      function Y(t) {
        switch (t.keyCode) {
    ...
    return (
      ...
      (c.extent = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : Eo(Uo(t))), c)
          : e;
      }),
      (c.filter = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : Eo(!!t)), c)
          : r;
      }),
      (c.touchable = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : Eo(!!t)), c)
          : i;
      }),
      ...
      u = (d = ua(0, aa - e * c) / d) ? e : aa / c;
      {
        ...
        for (const e of s) {
          ...
          if (t) {
            ...
            const t = fa(0, c).filter((t) => a[e * c + t] || a[t * c + e]);
  ...
  ya.prototype = va.prototype = {
    ...
    arc: function (t, n, e, r, i, o) {
      ...
      null === this._x1
        ? (this._ += "M" + c + "," + f)
        : (Math.abs(this._x1 - c) > pa || Math.abs(this._y1 - f) > pa) &&
          (this._ += "L" + c + "," + f),
        e &&
          (l < 0 && (l = (l % da) + da),
          l > ga
      ...
      if (
        ...
        if (t) {
          var m = +t.apply(this, arguments),
            x = v - m,
            w = (_ + b) / 2;
          c.quadraticCurveTo(0, 0, x * ea(_), x * ra(_)),
            c.lineTo(v * ea(w), v * ra(w)),
            c.lineTo(x * ea(b), x * ra(b));
        } else
          c.quadraticCurveTo(0, 0, v * ea(_), v * ra(_)), c.arc(0, 0, v, _, b);
      if ((c.quadraticCurveTo(0, 0, p * ea(g), p * ra(g)), c.closePath(), f))
  ...
  function Fa() {
    ...
    function i(t) {
      var n = e(t);
      if (Array.isArray(n)) n = n.slice().sort(Na);
      else {
        const e = g(t),
          r = L(e[0], e[1], n);
  ...
  class Ja {
    ...
    update() {
      ...
      for (let n = 0; n < o; n++) {
        if (n === h || n === d) continue;
        const e = eu(y, v, _, b, t[2 * n], t[2 * n + 1]);
        e < m && ((p = n), (m = e));
      }
      let x = t[2 * p],
        w = t[2 * p + 1];
      ...
      for (let n = 0; n < o; n++)
        this._dists[n] = tu(t[2 * n], t[2 * n + 1], M.x, M.y);
      ...
      for (let o, a, u = 0; u < this._ids.length; u++) {
        const c = this._ids[u],
          f = t[2 * c],
          s = t[2 * c + 1];
        if (u > 0 && Math.abs(f - o) <= Ka && Math.abs(s - a) <= Ka) continue;
        ...
        for (
          ;
          (g = e[y]),
            Za(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]) >= 0;
        ...
        for (
          ;
          (g = e[_]),
            Za(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]) < 0;
        ...
        if (y === l)
          for (
            ;
            (g = n[y]),
              Za(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0;
  ...
  function ru(t, n, e, r) {
    if (r - e <= 20)
      ...
      let i = e + 1,
        o = r;
      iu(t, (e + r) >> 1, i),
        n[t[e]] > n[t[r]] && iu(t, e, r),
        n[t[i]] > n[t[r]] && iu(t, i, r),
        n[t[e]] > n[t[i]] && iu(t, e, i);
      const a = t[i],
        u = n[a];
      for (;;) {
        do {
      ...
      (t[e + 1] = t[o]),
        (t[o] = a),
        r - i + 1 >= o - e
          ? (ru(t, n, i, r), ru(t, n, e, o - 1))
          : (ru(t, n, e, o - 1), ru(t, n, i, r));
    }
  }
  function iu(t, n, e) {
    const r = t[n];
  ...
  class cu {
    ...
    arc(t, n, e) {
      ...
      null === this._x1
        ? (this._ += `M${r},${i}`)
        : (Math.abs(this._x1 - r) > uu || Math.abs(this._y1 - i) > uu) &&
          (this._ += "L" + r + "," + i),
        e &&
          (this._ += `A${e},${e},0,1,1,${
            t - e
  ...
  class su {
    ...
    render(t) {
      const n = null == t ? (t = new cu()) : void 0,
        {
    ...
    renderCell(t, n) {
      const e = null == n ? (n = new cu()) : void 0,
        r = this._clip(t);
  ...
  class yu {
    ...
    *neighbors(t) {
    ...
    _step(t, n, e) {
      ...
      do {
        let r = u[h];
        const l = hu(n - c[2 * r], 2) + hu(e - c[2 * r + 1], 2);
        if (
          (l < s && ((s = l), (f = r)),
          (h = h % 3 == 2 ? h - 2 : h + 1),
          u[h] !== t)
        ...
        if (((h = a[h]), -1 === h)) {
          if (
            ((h = i[(o[t] + 1) % i.length]),
            h !== r && hu(n - c[2 * h], 2) + hu(e - c[2 * h + 1], 2) < s)
          )
            return h;
          break;
        }
    ...
    renderPoints(t, n) {
      void 0 !== n ||
        ...
        ((n = t), (t = null)),
        (n = null == n ? 2 : +n);
      const e = null == t ? (t = new cu()) : void 0,
        { points: r } = this;
      for (let e = 0, i = r.length; e < i; e += 2) {
        const i = r[e],
          o = r[e + 1];
        t.moveTo(i + n, o), t.arc(i, o, n, 0, lu);
      }
      return e && e.value();
    }
    renderHull(t) {
  ...
  function Mu(t) {
    ...
    function r(t, n) {
      ...
      for (
        ...
        for (var l = []; r !== vu && r !== _u; ) l.push(r), (r = s());
  ...
  function Wu(t) {
    return (n, e) =>
      Hu(n, e).then((n) => new DOMParser().parseFromString(n, t));
  }
  ...
  (ac.copy = function () {
    ...
    (ac.visit = function (t) {
      var n,
        ...
        c = this._root;
      for (
        c && u.push(new tc(c, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());
        ...
        if (
          ...
          var f = (r + o) / 2,
            s = (i + a) / 2;
          (e = c[3]) && u.push(new tc(e, f, s, o, a)),
            (e = c[2]) && u.push(new tc(e, r, s, f, a)),
            (e = c[1]) && u.push(new tc(e, f, i, o, s)),
            (e = c[0]) && u.push(new tc(e, r, i, f, s));
        }
      return this;
    }),
    (ac.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new tc(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            s = (a + c) / 2,
            l = (u + f) / 2;
          (o = i[0]) && e.push(new tc(o, a, u, s, l)),
            (o = i[1]) && e.push(new tc(o, s, u, c, l)),
            (o = i[2]) && e.push(new tc(o, a, l, s, f)),
            (o = i[3]) && e.push(new tc(o, s, l, c, f));
        }
        r.push(n);
      }
  ...
  var Ac = {
    ...
    s: function (t, n) {
      ...
      return o === a
        ...
        : "0." + new Array(1 - o).join("0") + vc(t, Math.max(0, n + o - 1))[0];
    },
  ...
  function Cc(n) {
    return (
      (Sc = Nc(n)),
      (t.format = Sc.format),
      (t.formatPrefix = Sc.formatPrefix),
      Sc
    );
  }
  function Pc(t) {
  ...
  function zc(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(_c(n) / 3))) - _c(Math.abs(t))
    );
  }
  function Dc(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, _c(n) - _c(t)) + 1
    );
  }
  (t.format = void 0),
    (t.formatPrefix = void 0),
    Cc({ thousands: ",", grouping: [3], currency: ["$", ""] });
  var qc = 1e-6,
    Rc = 1e-12,
    Fc = Math.PI,
    Oc = Fc / 2,
  ...
  var uf = {
    ...
    cf = {
      ...
      GeometryCollection: function (t, n) {
        for (var e = t.geometries, r = -1, i = e.length; ++r < i; ) af(e[r], n);
      },
    };
  function ff(t, n, e) {
    var r,
  ...
  function sf(t, n) {
    var e = -1,
      r = t.length;
    for (n.polygonStart(); ++e < r; ) ff(t[e], n, 1);
    n.polygonEnd();
  }
  function lf(t, n) {
  ...
  var hf,
    ...
    Cf = {
      ...
      polygonEnd: function () {
        var t = +kf;
        Nf.add(t < 0 ? Uc + t : t),
          (this.lineStart = this.lineEnd = this.point = of);
      },
      sphere: function () {
        Nf.add(Uc);
      },
  ...
  function as(t, n) {
    ...
    if (Af) {
      ...
      f ^ (u * xf < c && c < u * t)
        ? (o = i[1] * Bc) > mf && (mf = o)
        : f ^ (u * xf < (c = ((c + 360) % 360) - 180) && c < u * t)
        ? (o = -i[1] * Bc) < _f && (_f = o)
        : (n < _f && (_f = n), n > mf && (mf = n)),
        f
          ? t < xf
            ? hs(vf, t) > hs(vf, bf) && (bf = t)
            : hs(t, bf) > hs(vf, bf) && (vf = t)
          : bf >= vf
          ? (t < vf && (vf = t), t > bf && (bf = t))
          : t > xf
          ? hs(vf, t) > hs(vf, bf) && (bf = t)
  ...
  function Ds(t) {
    ...
    return (
      (t = Ns(t[0] * Yc, t[1] * Yc, t.length > 2 ? t[2] * Yc : 0)),
      (n.invert = function (n) {
    ...
    if (
      (t.forEach(function (t) {
        if (!((n = t.length - 1) <= 0)) {
          ...
          u.push((e = new Is(r, t, null, !0))),
            c.push((e.o = new Is(r, null, e, !1))),
            u.push((e = new Is(a, t, null, !1))),
            c.push((e.o = new Is(a, null, e, !0)));
        }
      }),
      u.length)
    ) {
      ...
      var o,
        ...
        h = {
          ...
          polygonEnd: function () {
            ...
            var t = Ls(o, r);
            a.length
              ? (l || (i.polygonStart(), (l = !0)), Us(a, Xs, t, e, i))
              : t &&
  ...
  function Xs(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - Oc - qc : Oc - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - Oc - qc : Oc - n[1])
    );
  }
  ks.invert = ks;
  var Gs = js(
      ...
      function (t) {
        ...
        return {
          ...
          point: function (l, h) {
            ...
            if (
              (!n && (f = c = g) && t.lineStart(),
              g !== c && (!(d = a(n, p)) || Os(n, d) || Os(p, d)) && (p[2] = 1),
              g !== c)
            )
              (s = 0),
                g
    ...
    return function (a) {
      ...
      function M(o, a) {
        ...
        if ((f && s.push([o, a]), v))
          ...
          var c = [
              (p = Math.max(Js, Math.min(Qs, p))),
              (g = Math.max(Js, Math.min(Qs, g))),
            ],
            m = [
              (o = Math.max(Js, Math.min(Qs, o))),
              (a = Math.max(Js, Math.min(Qs, a))),
            ];
  ...
  function bl() {
    ...
    function _() {
      return et(Gc(r / p) * p, e, p)
        .map(s)
        .concat(et(Gc(u / g) * g, a, g).map(l))
        .concat(
          et(Gc(n / h) * h, t, h)
            .filter(function (t) {
              return Lc(t % p) > qc;
  ...
  var ml,
    ...
    El = {
      ...
      polygonEnd: function () {
        (El.lineStart = El.lineEnd = El.point = of),
          Tl.add(Lc(Sl)),
          (Sl = new y());
      },
      result: function () {
          ...
          function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
            ...
            if (b > 4 * n && g--) {
              var m = a + h,
                ...
                A = ef((w /= M)),
                T =
                  Lc(Lc(w) - 1) < qc || Lc(o - l) < qc ? (o + l) / 2 : Hc(x, m),
                S = t(T, A),
                E = S[0],
                k = S[1],
                N = E - r,
  ...
  function Dh(t) {
    ...
    function N() {
      ...
      return (
        (e = Ns(y, v, _)), (u = Es(n, r)), (c = Es(e, u)), (a = Nh(u, S)), C()
      );
    }
    function C() {
      return (f = s = null), E;
    ...
    return (
      (a.invert = function (t, n) {
        var e = o - n,
          a = Hc(t, Lc(e)) * Qc(e);
        return (
          e * r < 0 && (a -= Fc * Qc(t) * Qc(e)),
          [a / r, ef((i - (t * t + e * e) * r * r) / (2 * r))]
        );
      }),
      a
    );
    ...
    return (
      (o.invert = function (t, n) {
        var e = i - n,
          o = Hc(t, Lc(e)) * Qc(e);
        return (
          e * r < 0 && (o -= Fc * Qc(t) * Qc(e)),
          [o / r, i - Qc(r) * Jc(t * t + e * e)]
        );
      }),
      o
    );
  ...
  function Jh(t, n) {
    var e = ef(Qh * Kc(n)),
      ...
      i = r * r * r;
    return [
      (t * Xc(e)) / (Qh * ($h + 3 * Wh * r + i * (7 * Zh + 9 * Kh * r))),
      e * ($h + Wh * r + i * (Zh + Kh * r)),
    ];
  }
  function td(t, n) {
  ...
  function Ed(t) {
    ...
    t: for (u = 3; u < i; ++u) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, o = Td(n);
        (r = r.next) !== e;
    ...
    for (r = gd(n), u = 0; u < i; ++u) ((n = t[u]).x -= r.x), (n.y -= r.y);
    return r.r;
  }
  function kd(t) {
  ...
  (Jh.invert = function (t, n) {
    for (
      ...
      ((o =
        (i =
          (r -= e =
            (r * ($h + Wh * i + o * (Zh + Kh * i)) - n) /
            ($h + 3 * Wh * i + o * (7 * Zh + 9 * Kh * i))) * r) *
        i *
        i),
      !(Lc(e) < Rc));
      ++a
    ...
    return [
      (Qh * t * ($h + 3 * Wh * i + o * (7 * Zh + 9 * Kh * i))) / Xc(r),
      ef(Kc(r) / Qh),
    ];
  }),
    (td.invert = Uh(jc)),
  ...
  function Zd(t, n, e, r, i, o) {
    for (
      ...
      v.push((a = { value: s, dice: c < f, children: _.slice(b, m) })),
        a.dice
          ? Od(a, e, r, i, w ? (r += (f * s) / w) : o)
          : $d(a, e, r, w ? (e += (c * s) / w) : i, o),
        (w -= s),
        (b = m);
    }
    return v;
      ...
      if ((a = t._squarify) && a.ratio === n)
        for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
          for (
            ...
            u.value += c[f].value;
          u.dice
            ? Od(u, e, r, i, d ? (r += ((o - r) * u.value) / d) : o)
            : $d(u, e, r, d ? (e += ((i - e) * u.value) / d) : i, o),
            (d -= u.value);
        }
  ...
  function np(t) {
    ...
    let r,
      i = 2;
    for (r = 2; r < n; ++r) {
      for (; i > 1 && Jd(t[e[i - 2]], t[e[i - 1]], t[r]) <= 0; ) --i;
      e[i++] = r;
    }
    return e.slice(0, i);
  }
  ...
  function Pp(t, n, e) {
    var r = t[0],
      ...
      a = n[1];
    return (
      i < r ? ((r = Cp(i, r)), (o = e(a, o))) : ((r = Cp(r, i)), (o = e(o, a))),
      function (t) {
        return o(r(t));
      }
    );
  ...
  function Fp(n, e, r, i) {
    ...
    switch ((i = xc(null == i ? ",f" : i)).type) {
      case "s":
        ...
        return (
          null != i.precision || isNaN((o = zc(a, u))) || (i.precision = o),
          t.formatPrefix(i, u)
        );
      case "":
      case "e":
      ...
      case "r":
        null != i.precision ||
          isNaN((o = Dc(a, Math.max(Math.abs(n), Math.abs(e))))) ||
  ...
  function Xp(n) {
    ...
    function u() {
      return (
        ...
        o()[0] < 0 ? ((e = Hp(e)), (r = Hp(r)), n(Yp, Lp)) : n(Up, Bp),
        i
      );
    }
    return (
  ...
  function Qp(t) {
    var n = t(Np, Np),
      e = 1;
    function r() {
      return 1 === e ? t(Np, Np) : 0.5 === e ? t(Zp, Kp) : t(Wp(e), Wp(1 / e));
    }
    return (
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            eg.setTime(+n), rg.setTime(+r), t(eg), t(rg), Math.floor(e(eg, rg))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  var gg = ig(
    ...
    xg = ig(
      function (t) {
        t.setTime(
          t - t.getMilliseconds() - t.getSeconds() * cg - t.getMinutes() * fg
        );
      },
      function (t, n) {
        t.setTime(+t + n * sg);
    ...
    Ag = ig(
      ...
      (t, n) =>
        (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * fg) / lg,
      (t) => t.getDate() - 1
    ),
    Tg = Ag,
    Sg = Ag.range;
  function Eg(t) {
    return ig(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * fg) / hg
        );
      }
    );
  }
  ...
  const [Ty, Sy] = Ay(wy, by, iy, ny, Qg, Wg),
    [Ey, ky] = Ay(Gg, jg, kg, Tg, wg, bg);
  function Ny(t) {
    if (0 <= t.y && t.y < 100) {
    ...
    function M(t, n) {
      return function (e) {
        ...
        if (
          ...
          "w" in o || (o.w = 1),
            "Z" in o
              ? ((i = (r = Cy(Py(o.y, 0, 1))).getUTCDay()),
                (r = i > 4 || 0 === i ? oy.ceil(r) : oy(r)),
                (r = ny.offset(r, 7 * (o.V - 1))),
                (o.y = r.getUTCFullYear()),
                (o.m = r.getUTCMonth()),
                (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
              : ((i = (r = Ny(Py(o.y, 0, 1))).getDay()),
                (r = i > 4 || 0 === i ? Ng.ceil(r) : Ng(r)),
                (r = Tg.offset(r, 7 * (o.V - 1))),
                (o.y = r.getFullYear()),
                (o.m = r.getMonth()),
        ...
        return "Z" in o
          ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), Cy(o))
          : Ny(o);
      };
    }
    function A(t, n, e, r) {
  ...
  function Bv(t, n) {
    return (
      (t = Uv(t)), Iy(cy.count(wy(t), t) + (4 === wy(t).getUTCDay()), n, 2)
    );
  }
  function Yv(t) {
    return t.getUTCDay();
  ...
  function Gv(t, n) {
    var e = t.getUTCDay();
    return Iy(
      (t = e >= 4 || 0 === e ? cy(t) : cy.ceil(t)).getUTCFullYear() % 1e4,
      n,
      4
    );
  }
  ...
  function Kv(n) {
    return (
      (Dy = zy(n)),
      (t.timeFormat = Dy.format),
      (t.timeParse = Dy.parse),
      (t.utcFormat = Dy.utcFormat),
      (t.utcParse = Dy.utcParse),
      Dy
    );
  }
  (t.timeFormat = void 0),
  ...
  var Jv = Date.prototype.toISOString
    ? function (t) {
        return t.toISOString();
      }
    : t.utcFormat(Qv);
  var t_ = +new Date("2000-01-01T00:00:00.000Z")
    ? function (t) {
        var n = new Date(t);
  ...
  var s_ = f_("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
    ...
    bb = new Array(3)
      ...
      .map(f_),
    mb = m_(bb);
  var xb = Zr(cr(300, 0.5, 0), cr(-240, 0.5, 1)),
    wb = Zr(cr(-100, 0.75, 0.35), cr(80, 1.5, 0.8)),
    Mb = Zr(cr(260, 0.75, 0.35), cr(80, 1.5, 0.8)),
    Ab = cr();
  var Tb = Te(),
    Sb = Math.PI / 3,
    Eb = (2 * Math.PI) / 3;
  ...
  function am(t, n) {
    ...
    return (
      (t = "function" == typeof t ? t : void 0 === t ? im : Db(t)),
      (n = "function" == typeof n ? n : void 0 === n ? om : Db(n)),
      (a.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Db(+n)), a)
          : t;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Db(+t)), a)
          : n;
      }),
      (a.defined = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : Db(!!t)), a)
          : e;
      }),
      (a.curve = function (t) {
  ...
  function um(t, n, e) {
    ...
    return (
      (t = "function" == typeof t ? t : void 0 === t ? im : Db(+t)),
      (n = "function" == typeof n ? n : Db(void 0 === n ? 0 : +n)),
      (e = "function" == typeof e ? e : void 0 === e ? om : Db(+e)),
      (c.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Db(+n)), (r = null), c)
          : t;
      }),
      (c.x0 = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Db(+n)), c)
          : t;
      }),
      (c.x1 = function (t) {
        return arguments.length
          ? ((r = null == t ? null : "function" == typeof t ? t : Db(+t)), c)
          : r;
      }),
      (c.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Db(+t)), (e = null), c)
          : n;
      }),
      (c.y0 = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Db(+t)), c)
          : n;
      }),
      (c.y1 = function (t) {
        return arguments.length
          ? ((e = null == t ? null : "function" == typeof t ? t : Db(+t)), c)
          : e;
      }),
      (c.lineX0 = c.lineY0 =
        function () {
  ...
  function bm(t) {
    ...
    return (
      ...
      (a.x = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : Db(+t)), a)
          : r;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : Db(+t)), a)
          : i;
      }),
      (a.context = function (t) {
    ...
    Um = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, c),
          t.lineTo(Rm * r - Fm * i, Fm * r + Rm * i),
          t.lineTo(Rm * o - Fm * a, Fm * o + Rm * a),
          t.lineTo(Rm * u - Fm * c, Fm * u + Rm * c),
          t.lineTo(Rm * r + Fm * i, Rm * i - Fm * r),
          t.lineTo(Rm * o + Fm * a, Rm * a - Fm * o),
          t.lineTo(Rm * u + Fm * c, Rm * c - Fm * u),
          t.closePath();
      },
    },
  ...
  function lx(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (sx(o) + sx(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function hx(t, n) {
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = _x(t), i = _x(n), o = 0, a = 1; a < e; ++o, ++a)
              this._context.bezierCurveTo(
                r[0][o],
                i[0][o],
                r[1][o],
  ...
  var kx = (t) => () => t;
  function Nx(t, { sourceEvent: n, target: e, transform: r, dispatch: i }) {
    Object.defineProperties(this, {
      type: { value: t, enumerable: !0, configurable: !0 },
      sourceEvent: { value: n, enumerable: !0, configurable: !0 },
      target: { value: e, enumerable: !0, configurable: !0 },
  ...
  Cx.prototype = {
    ...
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new Cx(this.k, this.x + this.k * t, this.y + this.k * n);
    },
    apply: function (t) {
  ...
  var Px = new Cx(1, 0, 0);
  function zx(t) {
    for (; !t.__zoom; ) if (!(t = t.parentNode)) return Px;
    return t.__zoom;
  }
  function Dx(t) {
    t.stopImmediatePropagation();
  ...
  (zx.prototype = Cx.prototype),
    (t.Adder = y),
    (t.Delaunay = yu),
    (t.FormatSpecifier = wc),
    (t.InternMap = v),
    (t.InternSet = _),
    (t.Node = pd),
    (t.Voronoi = su),
    ...
    (t.arc = function () {
      ...
      function c() {
        ...
        if ((u || (u = c = va()), l < s && ((f = l), (l = s), (s = f)), l > Yb))
          if (p > Hb - Yb)
            u.moveTo(l * Fb(h), l * Ub(h)),
              u.arc(0, 0, l, h, d, !g),
              s > Yb &&
                (u.moveTo(s * Fb(d), s * Ub(d)), u.arc(0, 0, s, d, h, g));
          else {
            var y,
              v,
              _ = h,
                  ...
                  k < S
                    ...
                    : (u.arc(
                      ...
                      u.arc(
                        ...
                        0,
                        l,
                        Rb(y.cy + y.y11, y.cx + y.x11),
                        Rb(v.cy + v.y11, v.cx + v.x11),
                        !g
                      ),
                      u.arc(
                        v.cx,
      ...
      return (
        ...
        (c.endAngle = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : Db(+t)), c)
            : o;
        }),
        (c.padAngle = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Db(+t)), c)
            : a;
        }),
        (c.context = function (t) {
        ...
        if (i)
          if ("true" === i) i = !0;
            ...
            if (
              ...
              continue;
            Bu && r[4] && !r[7] && (i = i.replace(/-/g, "/").replace(/T/, " ")),
              (i = new Date(i));
          } else i = e;
        else i = null;
        t[n] = i;
    ...
    (t.contourDensity = function () {
      ...
      return (
        (l.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Ca(+n)), l)
            : t;
        }),
        (l.y = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : Ca(+t)), l)
            : n;
        }),
        (l.weight = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : Ca(+t)), l)
            : e;
        }),
        (l.size = function (t) {
    ...
    (t.curveBundle = $m),
    (t.curveCardinal = Km),
    (t.curveCardinalClosed = Jm),
    (t.curveCardinalOpen = nx),
    (t.curveCatmullRom = ix),
    (t.curveCatmullRomClosed = ax),
    (t.curveCatmullRomOpen = cx),
    (t.curveLinear = rm),
    ...
    (t.drag = function () {
      ...
      function d(a, u) {
        if (!r && i.call(this, a, u)) {
          ...
          c &&
            (Un(a.view).on("mousemove.drag", p, Gn).on("mouseup.drag", g, Gn),
            Wn(a.view),
            Vn(a),
            (e = !1),
            (t = a.clientX),
      ...
      return (
        (h.filter = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : Kn(!!t)), h)
            : i;
        }),
        (h.container = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : Kn(t)), h)
            : o;
        }),
        (h.subject = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Kn(t)), h)
            : a;
        }),
        (h.touchable = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Kn(!!t)), h)
            : u;
        }),
        (h.on = function () {
    ...
    (t.forceCollide = function (t) {
      ...
      return (
        "function" != typeof t && (t = uc(null == t ? 1 : +t)),
        ...
        (a.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : uc(+n)), c(), a)
            : t;
        }),
        a
      );
    ...
    (t.forceLink = function (t) {
      ...
      function l(r) {
        for (var i = 0, u = t.length; i < s; ++i)
          for (var c, f, l, h, d, p, g, y = 0; y < u; ++y)
            (f = (c = t[y]).source),
              (h = (l = c.target).x + l.vx - f.x - f.vx || cc(a)),
              (d = l.y + l.vy - f.y - f.vy || cc(a)),
              (h *= p =
      ...
      function h() {
        if (r) {
          ...
          for (a = 0, i = new Array(f); a < s; ++a)
            ((c = t[a]).index = a),
              "object" != typeof c.source && (c.source = hc(l, c.source)),
              "object" != typeof c.target && (c.target = hc(l, c.target)),
      ...
      return (
        ...
        (l.strength = function (t) {
          return arguments.length
            ? ((c = "function" == typeof t ? t : uc(+t)), d(), l)
            : c;
        }),
        (l.distance = function (t) {
          return arguments.length
            ? ((f = "function" == typeof t ? t : uc(+t)), p(), l)
            : f;
        }),
        l
      );
    ...
    (t.forceManyBody = function () {
      ...
      return (
        ...
        (f.strength = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : uc(+t)), s(), f)
            : o;
        }),
    ...
    (t.forceRadial = function (t, n, e) {
      ...
      return (
        ...
        (u.strength = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : uc(+t)), c(), u)
            : a;
        }),
        (u.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : uc(+n)), c(), u)
            : t;
        }),
        (u.x = function (t) {
    ...
    (t.forceX = function (t) {
      ...
      return (
        "function" != typeof t && (t = uc(null == t ? 0 : +t)),
        (o.initialize = function (t) {
          (n = t), a();
        }),
        (o.strength = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : uc(+t)), a(), o)
            : i;
        }),
        (o.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : uc(+n)), a(), o)
            : t;
        }),
        o
      );
        ...
        (s.translate = function (t) {
          ...
          return (
            ...
            (r = u
              ...
              .clipExtent([
                [o - 0.425 * n + qc, s + 0.12 * n + qc],
                [o - 0.214 * n - qc, s + 0.234 * n - qc],
              ])
              .stream(f)),
            (i = c
              .translate([o - 0.205 * n, s + 0.212 * n])
              .clipExtent([
                [o - 0.214 * n + qc, s + 0.166 * n + qc],
                [o - 0.115 * n - qc, s + 0.234 * n - qc],
              ])
              .stream(f)),
            l()
          );
    ...
    (t.geoBounds = function (t) {
      var n, e, r, i, o, a, u;
      if (
        ((mf = bf = -(vf = _f = 1 / 0)), (Sf = []), lf(t, is), (e = Sf.length))
      ) {
        for (Sf.sort(ds), n = 1, o = [(r = Sf[0])]; n < e; ++n)
          ps(r, (i = Sf[n])[0]) || ps(r, i[1])
            ? (hs(r[0], i[1]) > hs(r[0], r[1]) && (r[1] = i[1]),
              hs(i[0], r[1]) > hs(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
        for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]),
            (u = hs(r[1], i[0])) > a && ((a = u), (vf = i[0]), (bf = r[1]));
      }
      return (
        (Sf = Ef = null),
        vf === 1 / 0 || _f === 1 / 0
    ...
    (t.geoCircle = function () {
      ...
      return (
        (a.center = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : Ss([+t[0], +t[1]])), a)
            : e;
        }),
        (a.radius = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Ss(+t)), a)
            : r;
        }),
        (a.precision = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : Ss(+t)), a)
            : i;
        }),
        a
      );
    }),
    (t.geoClipAntimeridian = Gs),
    (t.geoClipCircle = Vs),
    ...
    (t.geoPath = function (t, n) {
      ...
      return (
        ...
        (o.projection = function (n) {
          return arguments.length
            ? ((e = null == n ? ((t = null), Al) : (t = n).stream), o)
            : t;
        }),
        (o.context = function (t) {
          return arguments.length
            ? ((r = null == t ? ((n = null), new bh()) : new ch((n = t))),
    ...
    (t.groupSort = function (t, e, r) {
      return (
        1 === e.length
          ? z(E(t, e, r), ([t, e], [r, i]) => n(e, i) || n(t, r))
          : z(A(t, r), ([t, r], [i, o]) => e(r, o) || n(t, i))
      ).map(([t]) => t);
    }),
    (t.groups = T),
    (t.hcl = Ze),
    ...
    (t.interpolateBasis = lr),
    (t.interpolateBasisClosed = hr),
    (t.interpolateBlues = sb),
    (t.interpolateBrBG = w_),
    (t.interpolateBuGn = B_),
    (t.interpolateBuPu = L_),
    ...
    (t.interpolateCool = Mb),
    (t.interpolateCubehelix = Wr),
    (t.interpolateCubehelixDefault = xb),
    (t.interpolateCubehelixLong = Zr),
    (t.interpolateDate = Tr),
    ...
    (t.interpolateGnBu = H_),
    (t.interpolateGreens = hb),
    (t.interpolateGreys = pb),
    (t.interpolateHcl = Gr),
    (t.interpolateHclLong = Vr),
    (t.interpolateHsl = jr),
    (t.interpolateHslLong = Hr),
    ...
    (t.interpolateNumber = Sr),
    (t.interpolateNumberArray = wr),
    (t.interpolateObject = Er),
    (t.interpolateOrRd = G_),
    (t.interpolateOranges = mb),
    (t.interpolatePRGn = A_),
    (t.interpolatePiYG = S_),
    (t.interpolatePlasma = zb),
    (t.interpolatePuBu = Z_),
    (t.interpolatePuBuGn = $_),
    (t.interpolatePuOr = k_),
    (t.interpolatePuRd = Q_),
    (t.interpolatePurples = yb),
    ...
    (t.interpolateRdBu = C_),
    (t.interpolateRdGy = z_),
    (t.interpolateRdPu = tb),
    (t.interpolateRdYlBu = q_),
    (t.interpolateRdYlGn = F_),
    (t.interpolateReds = _b),
    (t.interpolateRgb = _r),
    (t.interpolateRgbBasis = mr),
    (t.interpolateRgbBasisClosed = xr),
    (t.interpolateRound = zr),
    (t.interpolateSinebow = function (t) {
      var n;
      return (
        (t = (0.5 - t) * Math.PI),
        (Tb.r = 255 * (n = Math.sin(t)) * n),
        (Tb.g = 255 * (n = Math.sin(t + Sb)) * n),
        (Tb.b = 255 * (n = Math.sin(t + Eb)) * n),
        Tb + ""
      );
    }),
    (t.interpolateSpectral = I_),
    (t.interpolateString = Cr),
    (t.interpolateTransformCss = Ir),
    ...
    (t.interpolateViridis = Nb),
    (t.interpolateWarm = wb),
    (t.interpolateYlGn = ib),
    (t.interpolateYlGnBu = eb),
    (t.interpolateYlOrBr = ab),
    (t.interpolateYlOrRd = cb),
    ...
    (t.pack = function () {
      ...
      function i(i) {
        return (
          ...
          (i.y = e / 2),
          t
            ? i.eachBefore(Dd(t)).eachAfter(qd(r, 0.5)).eachBefore(Rd(1))
            : i
                .eachBefore(Dd(zd))
                .eachAfter(qd(Cd, 1))
                .eachAfter(qd(r, i.r / Math.min(n, e)))
                .eachBefore(Rd(Math.min(n, e) / (2 * i.r))),
          i
        );
      }
      return (
    ...
    (t.radialLine = pm),
    (t.randomBates = cp),
    (t.randomBernoulli = lp),
    (t.randomBeta = pp),
    (t.randomBinomial = gp),
    (t.randomCauchy = vp),
    (t.randomExponential = fp),
    (t.randomGamma = dp),
    (t.randomGeometric = hp),
    (t.randomInt = ip),
    (t.randomIrwinHall = up),
    ...
    (t.scaleIdentity = function t(n) {
      ...
      return (
        ...
        (n = arguments.length ? Array.from(n, Ep) : [0, 1]),
        Op(r)
      );
    }),
    (t.scaleImplicit = Mp),
    ...
    (t.scaleRadial = function t() {
      ...
      return (
        ...
        (o.range = function (t) {
          return arguments.length
            ? (e.range((r = Array.from(t, Ep)).map(tg)), o)
            : r.slice();
        }),
    ...
    (t.scaleSequentialQuantile = function t() {
      ...
      return (
        ...
        (i.quantiles = function (t) {
          return Array.from({ length: t + 1 }, (n, r) => Z(e, r / t));
        }),
        (i.copy = function () {
          return t(r).domain(e);
        }),
    ...
    (t.scaleSequentialSqrt = function () {
      return a_.apply(null, arguments).exponent(0.5);
    }),
    ...
    (t.scaleTime = function () {
      return xp.apply(
        r_(Ey, ky, Gg, jg, kg, Tg, wg, bg, yg, t.timeFormat).domain([
          new Date(2e3, 0, 1),
          new Date(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.scaleUtc = function () {
      return xp.apply(
        r_(Ty, Sy, wy, by, iy, ny, Qg, Wg, yg, t.utcFormat).domain([
          Date.UTC(2e3, 0, 1),
          Date.UTC(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.selectAll = function (t) {
      return "string" == typeof t
        ? new On([document.querySelectorAll(t)], [document.documentElement])
        : new On([zt(t)], Fn);
    }),
    (t.selection = In),
    (t.selector = Pt),
    ...
    (t.stack = function () {
      ...
      function i(i) {
        ...
        for (o = 0, a = nm(n(u)); o < c; ++o) u[a[o]].index = o;
        return e(u, a), u;
      }
      return (
        (i.keys = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Db(Array.from(n))), i)
            : t;
        }),
        (i.value = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Db(+t)), i)
            : r;
        }),
        (i.order = function (t) {
          return arguments.length
    ...
    (t.symbol = function (t, n) {
      ...
      return (
        (t = "function" == typeof t ? t : Db(t || Mm)),
        (n = "function" == typeof n ? n : Db(void 0 === n ? 64 : +n)),
        (r.type = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Db(n)), r)
            : t;
        }),
        (r.size = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : Db(+t)), r)
            : n;
        }),
            ...
            for (
              ...
              (c = jd(c)),
                ...
                (i = u.z + l - o.z - f + t(u._, o._)) > 0 &&
                  (Xd(Gd(u, n, r), n, i), (f += i), (s += i)),
                (l += u.m),
                (f += o.m),
                (h += c.m),
                (s += a.m);
            u && !Hd(a) && ((a.t = u), (a.m += l - s)),
              o && !jd(c) && ((c.t = o), (c.m += f - h), (r = n));
          }
          return r;
        })(n, i, n.parent.A || r[0]);
      }
    ...
    (t.zoom = function () {
      ...
      function A(t, ...n) {
        ...
        function h(t) {
          ...
          a.event(t).zoom(
            "mouse",
            o(
              _(a.that.__zoom, (a.mouse[0] = Hn(t, i)), a.mouse[1]),
              a.extent,
              f
            )
          );
      ...
      function T(t, ...n) {
        if (r.apply(this, arguments)) {
          ...
          qx(t),
            s > 0
              ? Un(this).transition().duration(s).call(m, l, a, t)
              : Un(this).call(y.transform, l, a, t);
        }
      }
      function S(e, ...i) {
        if (r.apply(this, arguments)) {
      ...
      function k(t, ...r) {
        if (this.__zooming) {
          ...
          if (
            ...
            (a.end(),
            2 === a.taps &&
              ((o = Hn(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < g))
          ) {
      ...
      return (
        ...
        (y.wheelDelta = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : kx(+t)), y)
            : a;
        }),
        (y.filter = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : kx(!!t)), y)
            : r;
        }),
        (y.touchable = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : kx(!!t)), y)
            : u;
        }),
        (y.extent = function (t) {
          return arguments.length
